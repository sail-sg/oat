# Fused lm head to optimize memory usage. Adapted from https://github.com/volcengine/verl
...
class FusedLinearFunction(torch.autograd.Function):
    ...
    def forward(
        ...
        for chunk_start in range(0, T, chunk_size):
            ...
            chunk_log_probs, chunk_entropy = _fused_linear_fwd(
...
class FusedLinear(torch.nn.Module):
    ...
    def __init__(self, chunk_size: int = 512, compute_entropy: bool = True):
        super().__init__()
